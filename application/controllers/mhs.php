...
class Mhs extends CI_Controller {
    ...
    function Mhs()
    {
        parent::__construct();
        // set config database
        $this->load->model('Mhs_model', '', TRUE);
    ...
    public function count(){
        echo $this->Mhs_model->count();
    }

    public function get_all(){
        echo json_encode($this->Mhs_model->get_all());
    }
    public function insert(){
        $data = json_decode(file_get_contents("php://input"));
        echo  $this->Mhs_model->insert($data);
    }
    public function delete($id){
       echo $this->Mhs_model->delete($id);
    }
    public function getbyid($id){
        //data harus berupa json
        echo json_encode($this->Mhs_model->getbyid($id));
    }
    public  function update(){
        $data = json_decode(file_get_contents("php://input"));
        echo  $this->Mhs_model->update($data);
    }
