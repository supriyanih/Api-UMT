...
class Jadwal_dosen extends CI_Controller {
    ...
    function Jadwal_dosen()
    {
        parent::__construct();
        // set config database
        $this->load->model('Jadwaldosen_model', '', TRUE);
    ...
    public function count(){
        echo $this->Jadwaldosen_model->count();
    }

    public function get_all($data){
       
       
        echo json_encode($this->Jadwaldosen_model->get_all($data));
    }
    public function insert(){
        $data = json_decode(file_get_contents("php://input"));
        echo  $this->Jadwaldosen_model->insert($data);
    }
    public function delete($id){
       echo $this->Jadwaldosen_model->delete($id);
    }
    public function getbyid($id){
        //data harus berupa json
        echo json_encode($this->Jadwaldosen_model->getbyid($id));
    }
    public  function update(){
        $data = json_decode(file_get_contents("php://input"));
        echo  $this->Jadwaldosen_model->update($data);
    }
    ...
    public function get_all_bypaging(){
        ...
        $jam = $this->Jadwaldosen_model->get_all($data);
        $totaldata = count($jam);
